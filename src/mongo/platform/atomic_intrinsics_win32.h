    ...
    private:
        ...
        struct InterlockedImpl<false> {
            ...
            static T swap(volatile T* dest, T newValue) {
                ...
                T unsafeCurrentValue = *dest;
                while (true) {
                    const T result = compareAndSwap(dest, unsafeCurrentValue, newValue);
                    if (result == unsafeCurrentValue)
                        return result;
                    unsafeCurrentValue = *dest;
                }
            }
            ...
            static T fetchAndAdd(volatile T* dest, T increment) {
                ...
                T unsafeCurrentValue = *dest;
                while (true) {
                    const T incremented = unsafeCurrentValue + increment;
                    const T result = compareAndSwap(dest, unsafeCurrentValue, incremented);
                    if (result == unsafeCurrentValue)
                        return result;
                    unsafeCurrentValue = *dest;
                }
