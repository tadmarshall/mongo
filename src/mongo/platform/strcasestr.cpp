...
namespace dynamic {
    ...
    // 'strcasestr()' on Solaris will call the emulation unless the symbol
    // is found by MONGO_INITIALIZER(SolarisDynamicLinks) during platform_init
    //
    StrCaseStrFunc strcasestr = ::mongo::pal::emulation::strcasestr;
