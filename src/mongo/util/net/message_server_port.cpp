...
namespace mongo {
    ...
    public:
        ...
        virtual void acceptedMP(MessagingPort * p) {
            ...
            try {
                ...
                {
                    HandleIncomingMsgParam* handleIncomingMsgParam =
                            new HandleIncomingMsgParam(p, _handler);
                    boost::thread thr(boost::bind(&handleIncomingMsg, handleIncomingMsgParam));
                }
#else
                ...
                HandleIncomingMsgParam* handleIncomingMsgParam =
                        new HandleIncomingMsgParam(p, _handler);
                int failed = pthread_create(&thread, &attrs, &handleIncomingMsg,
                        handleIncomingMsgParam);
    ...
    private:
        ...
        static void* handleIncomingMsg(void* arg) {
            ...
            scoped_ptr<HandleIncomingMsgParam> handleIncomingMsgArg(
                    reinterpret_cast<HandleIncomingMsgParam *>(arg));
            MessagingPort* inPort = handleIncomingMsgArg->inPort;
            MessageHandler* handler = handleIncomingMsgArg->handler;
